...
build-docker-dev: ## Build Docker image for development (fast).
	...
	#CC=x86_64-linux-musl-gcc CGO_ENABLED=1 go run build.go -goos linux -pkg-arch amd64 ${OPT} build package-only latest
...
build-docker-full: ## Build Docker image for development.
	...
	docker build --tag utmdevdocker/grafana-utm:dev .
